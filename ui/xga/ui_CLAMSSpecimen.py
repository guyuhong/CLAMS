# Form implementation generated from reading ui file 'CLAMSSpecimen.ui'
#
...
class Ui_clamsSpecimen(object):
    def setupUi(self, clamsSpecimen):
        ...
        self.label_2 = QtWidgets.QLabel(parent=clamsSpecimen)
        ...
        self.protoBtn = QtWidgets.QPushButton(parent=self.bottomBox)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=clamsSpecimen)
        self.groupBox.setGeometry(QtCore.QRect(20, 70, 151, 481))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.btn_0 = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.btn_6 = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.btn_7 = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.btn_8 = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.btn_9 = QtWidgets.QPushButton(parent=self.groupBox)
