...
class Ui_clamsCatch(object):
    def setupUi(self, clamsCatch):
        ...
        self.editBtn = QtWidgets.QPushButton(parent=self.bottomBox)
        ...
        self.transBtn = QtWidgets.QPushButton(parent=self.bottomBox)
        self.transBtn.setGeometry(QtCore.QRect(10, 10, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.transBtn.setFont(font)
        self.transBtn.setObjectName("transBtn")
        self.printBtn = QtWidgets.QPushButton(parent=self.bottomBox)
