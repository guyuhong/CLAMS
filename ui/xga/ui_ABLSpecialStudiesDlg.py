...
class Ui_ablspeciesstudiesDlg(object):
    def setupUi(self, ablspeciesstudiesDlg):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=ablspeciesstudiesDlg)
        ...
        self.isotopeMarshBtn = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.geneticsBtn = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.energeticBtn = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.tsmriBtn = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.isotopeAndrewsBtn = QtWidgets.QPushButton(parent=self.groupBox)
